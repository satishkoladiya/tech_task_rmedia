...
import 'package:tech_task_rmedia/features/calendar_feature/views/calendar_screen/components/calendar_task_widget.dart';
    ...
    return SizedBox(
      ...
      child: DayView(
        ...
        eventTileBuilder: (date, events, boundary, startDuration, endDuration) {
          ...
          return Padding(
            padding: const EdgeInsets.all(Dimensions.small2),
            child: TaskWidget(
              task: Task(
                title: event.title,
